...
public class MavenConstants {
    public static final File LOCAL_REPO = new File(System.getProperty("user.home") + File.separatorChar + new StringJoiner(File.separator).add(".m2").add("repository").toString());
